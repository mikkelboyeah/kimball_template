...
**Rolling forward**: refers to the process of *incrementally updating* a snapshot table using the latest daily transactions, rather than recalculating the entire table from scratch.
...
### Complementary Policy Accumulating Snapshot Fact Table
